                        ...
                        <div class="bg-white h-full border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="p-5">
                                ...
                                <p class="flex items-center font-normal text-gray-400 text-sm dark:text-gray-400">
                                    ...
                                    <a @click="goCategoryArticleListPage(category.id, category.name)" v-for="(category, index) in categories" :key="index" class="text-gray-400 hover:underline"
                                    ><h v-if="category.name==article.category.name">{{category.name }}</h>
                                </a>
                                </p>
                            </div>
                        </div>
