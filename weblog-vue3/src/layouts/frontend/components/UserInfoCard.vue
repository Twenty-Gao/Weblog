    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-2">
                ...
                <!-- Gitee -->
                <svg v-if="blogSettingsStore.blogSettings.giteeHomepage" t="1698030969736" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2438" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.githubHomepage)">
                    <path
                ...
                <!-- 知乎 -->
                <svg v-if="blogSettingsStore.blogSettings.zhihuHomepage" t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="3419" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.githubHomepage)">
                ...
                <!-- CSDN -->
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="4386" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.githubHomepage)">
                    <path
