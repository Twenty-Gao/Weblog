...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("org.twentygao.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Twenty-Gao", "https://www.quanxiaoha.com", "2671628377@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}
